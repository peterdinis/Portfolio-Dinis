  ...
  return (
    <>
        ...
        <div className="w-full grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center">
                    <div className="p-4 rounded">
                        <img className="w-20" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/480px-Unofficial_JavaScript_logo_2.svg.png" />
                    </div>
                    <div className="ml-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center">
                    <div className="p-4 rounded">
                        <img className="w-20" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Postgresql_elephant.svg/640px-Postgresql_elephant.svg.png" />
                    </div>
                    <div className="ml-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center">
                    <div className="p-4 rounded">
                        <img className="w-20" src="https://d1wrxu8gicsgam.cloudfront.net/wp-content/files/django-logo-big.jpg" />
                    </div>
                    <div className="ml-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center">
                    <div className="p-4 rounded">
                        <img className="w-20" src="https://labs.macrosoft.sk/static/pages/img/database/mysql-logo-2.png" />
                    </div>
                    <div className="ml-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center">
                    <div className="p-4 rounded">
                        <img className="w-20" src="https://miro.medium.com/max/256/1*Y6USBdJWvRYVyDPh8fF7_A.png" />
                    </div>
                    <div className="ml-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center">
                    <div className="p-4 rounded">
                        <img className="w-20" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/HTML5_logo_and_wordmark.svg/1200px-HTML5_logo_and_wordmark.svg.png" />
                    </div>
                    <div className="ml-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center">
                    <div className="p-4 rounded">
                        <img className="w-20" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/CSS3_logo_and_wordmark.svg/1200px-CSS3_logo_and_wordmark.svg.png" />
                    </div>
                    <div className="ml-6">
